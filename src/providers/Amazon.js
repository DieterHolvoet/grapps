...
class Amazon extends Provider {
    constructor() {
        ...
        this.logo = 'assets/svg/provider_logo/amazon_appstore.svg';
    }
}

export class AmazonSpecialDiscounts extends Amazon {
    constructor() {
        super();

        this.url = 'https://www.amazon.com/b?node=8605426011';
    ...
    handler(data) {
        ...
        $data.find('.s-result-item').each((i, eventItem) => {
            ...
            const $np = $eventItem.find('.a-row.a-spacing-none .a-button-inner span span');
...
export class AmazonFeaturedApps extends Amazon {
    constructor() {
        super();
...
export class AmazonDeals extends Amazon {
    constructor() {
        super();

        this.url = 'http://www.amazon.com/s/node=2446009011';
        this.moredeals = this.url;
        this.location = 'col-2';
        this.appearance = 'app-list';
        this.columns = 'double-column';
    ...
    handler(data) {
        ...
        $data.find('li.ilo2').each((i, eventItem) => {
            const $eventItem = $(eventItem);
            const app = new App(self);
